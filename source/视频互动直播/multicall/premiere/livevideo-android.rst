...
**开始集成视频互动直播功能前，请先实现 JCMediaDeviceCallback, JCMediaChannelCallback 回调，用于接收 JCMediaDevice 和 JCMediaChannel 的相关通知** 
...
**如果角色为主播，则需要在加入频道前打开音频，上传本地音频流。如果为观众，则不需要。**
...
**如果角色为主播，则需要在加入频道前打开视频设备，上传本地视频流。如果为观众，则不需要。**
...
视频直播中，还可以与观众互动连麦，请参考 :ref:`互动连麦<互动连麦(android)>`。
