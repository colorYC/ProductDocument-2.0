...
**开始集成多方语音通话功能前，请先实现 JCMediaDeviceCallback, JCMediaChannelCallback 回调，用于接收 JCMediaDevice 和 JCMediaChannel 的相关通知** 
...
解散失败原因请参考 `MediaChannelReason <https://developer.juphoon.com/portal/reference/V2.0/android/>`_。
